        ...
        <div className="mx-auto flex min-h-[90vh] max-w-7xl flex-col items-center justify-center px-6 py-24 lg:flex-row lg:gap-16">
          ...
          <div className="max-w-2xl flex-1 text-center lg:text-left">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground sm:text-xl">
              Master web development, AI, design, and business with
              project-based courses designed to help you build real-world skills
              and land opportunities faster.
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground lg:justify-start">
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  <Image
                    src={
                      "https://images.pexels.com/photos/7665702/pexels-photo-7665702.jpeg"
                    }
                    alt="user-1"
                    width={32}
                    height={32}
                  ...
                  <Image
                    src={
                      "https://images.pexels.com/photos/25974701/pexels-photo-25974701.jpeg"
                    }
                    alt="user-1"
                    width={32}
                    height={32}
                    className="h-8 w-8 rounded-full border-2 border-background bg-primary/30"
                  />
                  <Image
                    src={
                      "https://images.pexels.com/photos/15502152/pexels-photo-15502152.jpeg"
                    }
                    alt="user-1"
                    width={32}
                    height={32}
                    className="h-8 w-8 rounded-full border-2 border-background bg-primary/40"
                  />
                </div>
